...
SECRET_KEY = 'django-insecure-f&7#4_g3&u_+ioinn=sqi(15sh2lm^&ssajc4yvz-icthvi-8o'
...
# Tell Django to look for static files in this directory as well (for dev only)
STATICFILES_DIRS = [
